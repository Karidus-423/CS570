...
static void ssnfsprog_1(struct svc_req *rqstp, register SVCXPRT *transp) {
    union {
    ...
    case open_file:
        printf("Recieved open_file procedure.\n");
    ...
    case seek_position:
        _xdr_argument = (xdrproc_t)xdr_seek_input;
        _xdr_result = (xdrproc_t)xdr_seek_output;
